...
public class EmiCalcutorActivity extends AppCompatActivity {
    private static EmiCalculatorActivity SumTotalb;
    public float Months;
    public float Rate;
    ...
    public void onCreate(Bundle bundle) {
        ...
        ic_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(EmiCalcutorActivity.this, CalculatorActivity.class));
            }
        });
        ...
        this.pAmt.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable editable) {
                try {
                    EmiCalcutorActivity.this.pAmt.removeTextChangedListener(this);
                    String obj = EmiCalcutorActivity.this.pAmt.getText().toString();
                    if (obj != null && !obj.equals("")) {
                        if (obj.startsWith(".")) {
                            EmiCalcutorActivity.this.pAmt.setText("0.");
                        }
                        if (obj.startsWith("0") && !obj.startsWith("0.")) {
                            EmiCalcutorActivity.this.pAmt.setText("");
                        }
                        String replaceAll = EmiCalcutorActivity.this.pAmt.getText().toString().replaceAll(",", "");
                        if (!obj.equals("")) {
                            EmiCalcutorActivity.this.pAmt.setText(EmiCalcutorActivity.a(",", replaceAll));
                        }
                        EditText editText = EmiCalcutorActivity.this.pAmt;
                        editText.setSelection(editText.getText().toString().length());
                    }
                    EmiCalcutorActivity.this.pAmt.addTextChangedListener(this);
                } catch (Exception e) {
                    e.printStackTrace();
                    EmiCalcutorActivity.this.pAmt.addTextChangedListener(this);
                }
    ...
    public static String a(String s, String str) {
        String str2;
    ...
    private String a(String str2, String s, String str3) {
        return null;
    }
    ...
    public void onBackPressed() {
        startActivity(new Intent(EmiCalcutorActivity.this, LogoActivity.class));
    }
}
